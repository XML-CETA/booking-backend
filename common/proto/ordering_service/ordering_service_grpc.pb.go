...
const (
	OrderingService_Get_FullMethodName         = "/OrderingService/Get"
	OrderingService_GetAll_FullMethodName      = "/OrderingService/GetAll"
	OrderingService_CreateOrder_FullMethodName = "/OrderingService/CreateOrder"
)
...
func (c *orderingServiceClient) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	out := new(GetResponse)
	err := c.cc.Invoke(ctx, OrderingService_Get_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *orderingServiceClient) GetAll(ctx context.Context, in *GetAllRequest, opts ...grpc.CallOption) (*GetAllResponse, error) {
	...
	err := c.cc.Invoke(ctx, OrderingService_GetAll_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _OrderingService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrderingService_Get_FullMethodName,
	}
...
var OrderingService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "ordering_service/ordering_service.proto",
}
