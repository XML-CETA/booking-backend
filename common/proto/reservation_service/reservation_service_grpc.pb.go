...
const (
	...
	ReservationService_GetFlightsForReservation_FullMethodName = "/ReservationService/GetFlightsForReservation"
)
...
type ReservationServiceClient interface {
	...
	GetFlightsForReservation(ctx context.Context, in *FlightForReservationRequest, opts ...grpc.CallOption) (*FlightForReservationResponse, error)
}
...
func (c *reservationServiceClient) GetFlightsForReservation(ctx context.Context, in *FlightForReservationRequest, opts ...grpc.CallOption) (*FlightForReservationResponse, error) {
	out := new(FlightForReservationResponse)
	err := c.cc.Invoke(ctx, ReservationService_GetFlightsForReservation_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ReservationServiceServer interface {
	...
	GetFlightsForReservation(context.Context, *FlightForReservationRequest) (*FlightForReservationResponse, error)
...
func (UnimplementedReservationServiceServer) GetFlightsForReservation(context.Context, *FlightForReservationRequest) (*FlightForReservationResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetFlightsForReservation not implemented")
}
...
func _ReservationService_GetFlightsForReservation_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FlightForReservationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ReservationServiceServer).GetFlightsForReservation(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReservationService_GetFlightsForReservation_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReservationServiceServer).GetFlightsForReservation(ctx, req.(*FlightForReservationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ReservationService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetFlightsForReservation",
			Handler:    _ReservationService_GetFlightsForReservation_Handler,
		},
	},
