...
type WaitingReservation struct {
	...
	DateTo                         string `protobuf:"bytes,5,opt,name=dateTo,proto3" json:"dateTo,omitempty"`
	Guests                         int32  `protobuf:"varint,6,opt,name=guests,proto3" json:"guests,omitempty"`
	UserCanceledReservationsNumber int32  `protobuf:"varint,7,opt,name=userCanceledReservationsNumber,proto3" json:"userCanceledReservationsNumber,omitempty"`
}
...
func (x *WaitingReservation) GetUserCanceledReservationsNumber() int32 {
	if x != nil {
		return x.UserCanceledReservationsNumber
	}
	return 0
}
...
var file_reservation_service_reservation_service_proto_rawDesc = []byte{
	...
	0x6f, 0x73, 0x74, 0x22, 0xf2, 0x01, 0x0a, 0x12, 0x57, 0x61, 0x69, 0x74, 0x69, 0x6e, 0x67, 0x52,
	...
	0x12, 0x46, 0x0a, 0x1e, 0x75, 0x73, 0x65, 0x72, 0x43, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x65, 0x64,
	0x52, 0x65, 0x73, 0x65, 0x72, 0x76, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x4e, 0x75, 0x6d, 0x62,
	0x65, 0x72, 0x18, 0x07, 0x20, 0x01, 0x28, 0x05, 0x52, 0x1e, 0x75, 0x73, 0x65, 0x72, 0x43, 0x61,
	0x6e, 0x63, 0x65, 0x6c, 0x65, 0x64, 0x52, 0x65, 0x73, 0x65, 0x72, 0x76, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x73, 0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x22, 0x0f, 0x0a, 0x0d, 0x47, 0x65, 0x74, 0x41,
	...
	0x32, 0x91, 0x03, 0x0a, 0x12, 0x52, 0x65, 0x73, 0x65, 0x72, 0x76, 0x61, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x77, 0x61, 0x69, 0x74, 0x69, 0x6e, 0x67, 0x12, 0x5b, 0x0a, 0x06, 0x44, 0x65, 0x6c, 0x65, 0x74,
...
var file_reservation_service_reservation_service_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_reservation_service_reservation_service_proto_goTypes = []interface{}{
	...
	(*DeleteReservationRequest)(nil),           // 8: DeleteReservationRequest
...
var file_reservation_service_reservation_service_proto_depIdxs = []int32{
	...
	6, // 3: ReservationService.GetAll:input_type -> GetAllRequest
	2, // 4: ReservationService.GetWaitingReservations:input_type -> WaitingReservationsForHostRequest
	8, // 5: ReservationService.Delete:input_type -> DeleteReservationRequest
	1, // 6: ReservationService.Create:output_type -> ReservationCreateResponse
	7, // 7: ReservationService.GetAll:output_type -> GetAllResponse
	3, // 8: ReservationService.GetWaitingReservations:output_type -> WaitingReservationsForHostResponse
	9, // 9: ReservationService.Delete:output_type -> DeleteReservationResponse
