...
import (
	"fmt"
	shipping "booking-backend/common/proto/shipping_service"
	...
	"booking-backend/shipping_service/infrastructure/api"
	"booking-backend/shipping_service/infrastructure/persistence"
	"booking-backend/shipping_service/startup/config"
