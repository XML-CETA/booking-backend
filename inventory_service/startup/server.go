...
import (
	"fmt"
	inventory "booking-backend/common/proto/inventory_service"
	...
	"booking-backend/inventory_service/infrastructure/api"
	"booking-backend/inventory_service/infrastructure/persistence"
	"booking-backend/inventory_service/startup/config"
