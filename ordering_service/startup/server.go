...
import (
	"fmt"
	ordering "booking-backend/common/proto/ordering_service"
	saga "booking-backend/common/saga/messaging"
	"booking-backend/common/saga/messaging/nats"
	"booking-backend/ordering_service/application"
	"booking-backend/ordering_service/domain"
	"booking-backend/ordering_service/infrastructure/api"
	"booking-backend/ordering_service/infrastructure/persistence"
	"booking-backend/ordering_service/startup/config"
