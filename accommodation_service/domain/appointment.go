...
func DateIntervalToString(interval DateInterval) (string, string) {
	dateFromString := interval.DateFrom.Format(time.DateOnly)
	dateToString := interval.DateTo.Format(time.DateOnly)
